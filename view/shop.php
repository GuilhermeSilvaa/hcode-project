<?php include_once("header.php");?>
	...
	<section>
		<div class="container" id="destaque-produtos-container" ng-controller="destaque-controller">
			<div id="destaque-produtos" class="owl-two owl-two">
				<div class="row" ng-repeat="produto in produtos"> 
					...
					<div class="col-sm-6 col-descricao">
						...
						<div class="box-valor">
							...
							<div class="text-valor text-roxo">{{produto.preço}}</div>
				...
				<div class="col-md-3">
					<div class="box-produto-info">
						<a href="#">
							...
							<img src="img/panelas.png" alt="Panelas" class="produto-img">
							<h3>Conjunto de Pnaleas Tramotina Versalhes Alumínio Antiaderente 5 </h3>
